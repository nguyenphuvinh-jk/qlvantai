                        ...
                        <form class="new-added-form" action="{{URL::to('/quan-ly-khach-hang/hop-dong-van-chuyen/capnhat/'.$hd_edit->hd_id)}}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12-xxxl col-lg-6 col-12 form-group">
                                    ...
                                    <select class="select2" name="trangthai_hd">
                                        <option value="">Chọn trạng thái</option>
                                        <option value="0" {{$hd_edit->trangthai_hd == 0? 'selected': ''}}>Còn hạn</option>
                                        <option value="1" {{$hd_edit->trangthai_hd == 1? 'selected': ''}}>Hết hạn</option>
                                    </select>
                        ...
                        <table class="table display data-table text-nowrap" id="hopdong_table">
                            ...
                            @foreach($hopdong as $key => $hd)
                                <tr>
                                    ...
                                    <td><?php echo ($hd->trangthai_hd == 0) ? "Còn hạn" : "Hết hạn"  ?></td>
