                    ...
                    <div class="card-body">
                        ...
                        <form class="new-added-form" action="{{URL::to('/quan-ly-xe/sua-chua/bao-duong/luu')}}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-6 col-12 form-group">
                                    <label>Ngày sửa</label>
                                    <input type="text" placeholder="dd/mm/yyyy" class="form-control air-datepicker" data-position='bottom right' name="ngaysua">
                                    <i class="far fa-calendar-alt"></i>
                                    @if ($errors->has('ngaysua'))
                                        <p class="text-danger font-italic">{{ $errors->first('ngaysua') }}</p>
                                    @endif
                                ...
                                <div class="col-xl-12 col-lg-6 col-12 form-group">
                                    <label>Nội dung sửa</label>
                                    <textarea type="text" placeholder="" class="form-control" name="noidung"></textarea>
                                    @if ($errors->has('noidung'))
                                        <p class="text-danger font-italic">{{ $errors->first('noidung') }}</p>
                                    @endif
                                </div>
                                <div class="col-xl-12 col-lg-6 col-12 form-group">
                                    <label>Tổng tiền</label>
                                    <input type="text" placeholder="" class="form-control" name="tongtien">
                                    @if ($errors->has('tongtien'))
                                        <p class="text-danger font-italic">{{ $errors->first('tongtien') }}</p>
                                    @endif
                                </div>
                                ...
                                <td class="noExl">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a onclick="return confirm('Có chắc muốn xoá chưa?')" class="dropdown-item" href="{{URL::to('/quan-ly-xe/sua-chua/bao-duong/xoa/'.$sua->suachua_id)}}"><i
