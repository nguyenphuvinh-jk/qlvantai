                    ...
                    <form class="new-added-form" action="{{URL::to('/quan-ly-van-chuyen/hoa-don-van-chuyen/them/luu')}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                ...
                                <input type="text" placeholder="" class="form-control" name="phithuexe">
                            ...
                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                ...
                                <input type="text" placeholder="" class="form-control" name="phinang">
                            ...
                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                <label>Phí hạ</label>
                                <input type="text" placeholder="" class="form-control" name="phiha">
                                @if ($errors->has('phiha'))
                            ...
                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                ...
                                <input type="text" placeholder="" class="form-control" name="phigiayto">
                            ...
                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                ...
                                <input type="text" placeholder="" class="form-control" name="philuuca">
                            ...
                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                ...
                                <input type="text" placeholder="" class="form-control" name="vecauduong">
                                @if ($errors->has('vecauduong'))
                                    <p class="text-danger font-italic">{{ $errors->first('vecauduong') }}</p>
                                @endif
                            </div>
                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                <label>Phí khác</label>
                                <input type="text" placeholder="" class="form-control" name="phikhac">
                            ...
                            <div class="col-xl-3 col-lg-6 col-12 form-group">
                                ...
                                <input type="text" placeholder="" class="form-control" name="thue">
                                @if ($errors->has('thue'))
