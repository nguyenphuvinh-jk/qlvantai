    ...
    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
        ...
        <li class="nav-item sidebar-nav-item">
            ...
            <ul class="nav sub-group-menu {{ request()->is('quan-ly-tai-xe*') ? 'sub-group-active' : '' }}">
                <li class="nav-item">
                    <a href="{{URL::to('/quan-ly-tai-xe/thong-tin-tai-xe')}}" class="nav-link {{ request()->is('quan-ly-tai-xe/thong-tin-tai-xe*') ? 'menu-active' : '' }}"><i class="fas fa-angle-right"></i>Thông tin tài xế</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="{{URL::to('/quan-ly-tai-xe/tinh-luong')}}" class="nav-link {{ request()->is('quan-ly-tai-xe/tinh-luong*') ? 'menu-active' : '' }}"><i class="fas fa-angle-right"></i>Tính lương</a>
                </li>
            </ul>
        </li>
