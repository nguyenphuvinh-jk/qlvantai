            ...
            <form class="new-added-form" action="{{URL::to('/quan-ly-van-chuyen/don-hang/them/luu')}}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                        ...
                        <input type="text" placeholder="dd/mm/yyyy" class="form-control air-datepicker" data-position="bottom right" name="ngaydat">
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                        ...
                        <input type="text" placeholder="" class="form-control" name="trongluong">
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                        ...
                        <input type="text" placeholder="" class="form-control" name="dd_layhang">
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                        ...
                        <input type="text" placeholder="" class="form-control" name="dd_giaohang">
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                        ...
                        <input type="text" placeholder="" class="form-control" name="tg_batdau">
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                        ...
                        <input type="text" placeholder="dd/mm/yyyy" class="form-control air-datepicker" data-position="bottom right" name="ngaybatdau">
                        <i class="far fa-calendar-alt"></i>
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                        ...
                        <input type="text" placeholder="dd/mm/yyyy" class="form-control air-datepicker" data-position="bottom right" name="ngayketthuc">
                        <i class="far fa-calendar-alt"></i>
                    ...
                    <div class="col-xl-3 col-lg-6 col-12 form-group">
                        ...
                        <input type="text" placeholder="" class="form-control" name="gioluuca">
